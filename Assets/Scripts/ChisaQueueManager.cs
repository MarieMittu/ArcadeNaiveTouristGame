...
public class ChisaQueueManager : MonoBehaviour
{
    ...
    private static ChisaQueueManager _instance;

    private ChisaQueueManager() { }

    public static ChisaQueueManager Instance
    {
        get
        {
            if (_instance == null)
                _instance = new ChisaQueueManager();
